...
# rem 제거시 아래와 같이 수행
"""
rem dism.exe /online /enable-feature /featurename:Microsoft-Windows-Subsystem-Linux /norestart
rem dism.exe /online /enable-feature /featurename:VirtualMachinePlatform /norestart
"""
...
mkdir /data
mkdir /app
chown -R kaydash:kaydash /data
chown -R kaydash:kaydash /app
# 윈도우 파일탐색기: \\wsl$
# wsl(우분투) 마운트 경로: /mnt/c/
